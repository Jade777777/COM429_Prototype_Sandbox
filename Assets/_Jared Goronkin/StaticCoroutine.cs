...
using UnityEngine;
/// <summary>
/// Code found on stack exchange, It's been modified a bit.
/// </summary>
public class StaticCoroutine : MonoBehaviour
{
    ...
    private static StaticCoroutine Build()
    {
        ...
        //if instance is not defined and cannot be found accross all of our game objects, we create our own.
        GameObject instanceObject = new GameObject("StaticCoroutine");
        m_instance = instanceObject.AddComponent<StaticCoroutine>();
